...
export function Layout() {
  ...
  return (
    <div className="app-shell min-h-screen bg-ink-3 text-bone relative selection:bg-bone selection:text-ink transition-colors duration-300 overflow-x-hidden">
      ...
      <div className="ambient-glow-3 fixed bottom-[-100px] left-[20%] w-[600px] h-[600px] rounded-full bg-gradient-to-tr from-[#f3e8ff] via-[#e0e7ff] to-transparent blur-[80px] md:blur-[130px] pointer-events-none -z-10 opacity-40 md:opacity-60 will-change-transform" />
