      ...
      <div className="relative flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-4 grid grid-cols-3 gap-2">
            ...
            <div className="rounded-xl border border-line/50 bg-ink/60 p-2.5"><TrendingUp size={13} className="mb-1 text-amber" /><div className="font-mono text-xs">{displayVolume > 0 ? displayVolume.toLocaleString() : displayBodyweightReps > 0 ? displayBodyweightReps : '0'}<span className="ml-1 text-[10px] text-bone-dim">{displayVolume > 0 ? 'kg·r' : 'BW reps'}</span></div></div>
            <div className="rounded-xl border border-line/50 bg-ink/60 p-2.5"><Flame size={13} className="mb-1 text-danger" /><div className="font-mono text-xs">{details.calories || 0}<span className="ml-1 text-[10px] text-bone-dim">kcal</span></div></div>
          </div>
