...
export function EditChallengeSheet({ challenge, isOpen, onClose }: { challenge: ChallengeV2, isOpen: boolean, onClose: () => void }) {
  ...
  const [visibility, setVisibility] = useState<'public' | 'clan_only'>(challenge.visibility);
        ...
        <div className="fixed inset-0 z-[400] flex flex-col justify-end">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-bone">Edit Challenge</h2>
            ...
            <div className="flex-1 overflow-y-auto space-y-4 pr-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm text-bone-dim mb-1 ml-2">Target</label>
                  <input 
                ...
                <div>
                  <label className="block text-sm text-bone-dim mb-1 ml-2">Unit</label>
                  <input 
            ...
            <div className="pt-4 border-t border-line/10 mt-auto">
              <button 
                ...
                disabled={!title.trim() || !target || updateMutation.isPending}
