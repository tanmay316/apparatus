            ...
            <div className="flex items-center justify-between mb-4 pb-3 border-b border-line/20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-bone-dim">Share updates, PRs & tips with clan members</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
              ...
              <div className="flex items-center justify-between pt-3 border-t border-line/20 mt-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    type="submit"
                    disabled={(!postText.trim() && !title.trim() && images.length === 0) || createMutation.isPending || isProcessingImage}
