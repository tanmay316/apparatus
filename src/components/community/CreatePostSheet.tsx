            ...
            <div className="fixed inset-0 z-[600] flex flex-col justify-end sm:justify-center sm:items-center sm:p-4">
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
                  {/* Title Field */}
                  <div>
                    <label htmlFor="create-post-title" className="block text-[11px] font-mono uppercase text-bone-dim mb-1.5 tracking-wider">
                      Title (Optional)
                    </label>
                    <input
                  ...
                  {/* Body Textarea */}
                  <div>
                    <label htmlFor="create-post-content" className="block text-[11px] font-mono uppercase text-bone-dim mb-1.5 tracking-wider">
                      Post Content
                    </label>
                    <textarea
