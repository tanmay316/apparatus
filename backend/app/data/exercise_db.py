...
EXERCISES: List[ExerciseMetadata] = [
    ...
    _ex("Barbell Shrugs", "barbell", MovementPattern.ISOLATION_SHOULDERS, ExerciseCategory.ISOLATION, ["traps"], cns=5, spine=4, shoulder=4, elbow=2, hyper=90, str_score=70),
    ...
    # ── Isolation ──
    _ex("Dumbbell Lateral Raise", "dumbbell", MovementPattern.ISOLATION_SHOULDERS, ExerciseCategory.ISOLATION, ["lateral_delt"], cns=2, shoulder=4, hyper=100, str_score=30),
    _ex("Cable Lateral Raise", "cable", MovementPattern.ISOLATION_SHOULDERS, ExerciseCategory.ISOLATION, ["lateral_delt"], cns=2, shoulder=3, hyper=100, str_score=20),
    _ex("Dumbbell Bicep Curl", "dumbbell", MovementPattern.ISOLATION_BICEPS, ExerciseCategory.ISOLATION, ["biceps"], cns=2, elbow=4, hyper=100, str_score=40),
    _ex("Hammer Curl", "dumbbell", MovementPattern.ISOLATION_BICEPS, ExerciseCategory.ISOLATION, ["biceps", "brachialis"], cns=2, elbow=3, hyper=100, str_score=40),
    _ex("Reverse Curl", "barbell", MovementPattern.ISOLATION_BICEPS, ExerciseCategory.ISOLATION, ["forearms", "brachialis"], cns=2, elbow=3, hyper=90, str_score=40),
    _ex("Preacher Curl", "machine", MovementPattern.ISOLATION_BICEPS, ExerciseCategory.ISOLATION, ["biceps"], cns=2, elbow=5, hyper=100, str_score=40),
    _ex("Tricep Pushdown", "cable", MovementPattern.ISOLATION_TRICEPS, ExerciseCategory.ISOLATION, ["triceps"], cns=2, elbow=5, hyper=100, str_score=30),
    _ex("Dumbbell Kickbacks", "dumbbell", MovementPattern.ISOLATION_TRICEPS, ExerciseCategory.ISOLATION, ["triceps"], cns=1, elbow=3, hyper=80, str_score=20),
    _ex("Skull Crushers", "barbell", MovementPattern.ISOLATION_TRICEPS, ExerciseCategory.ISOLATION, ["triceps"], cns=3, elbow=7, hyper=100, str_score=40),
    _ex("Overhead Tricep Extension", "dumbbell", MovementPattern.ISOLATION_TRICEPS, ExerciseCategory.ISOLATION, ["triceps"], cns=2, elbow=5, hyper=100, str_score=30),
    _ex("Reverse Pec Deck", "machine", MovementPattern.ISOLATION_SHOULDERS, ExerciseCategory.ISOLATION, ["rear_delt"], cns=1, shoulder=2, hyper=100, str_score=20),
    _ex("Leg Extension", "machine", MovementPattern.ISOLATION_LEGS, ExerciseCategory.ISOLATION, ["quads"], cns=3, knee=7, hyper=100, str_score=30),
    _ex("Leg Curl", "machine", MovementPattern.ISOLATION_LEGS, ExerciseCategory.ISOLATION, ["hamstrings"], cns=3, knee=4, hyper=100, str_score=30),
    ...
    _ex("Band Face Pull", "band", MovementPattern.ISOLATION_SHOULDERS, ExerciseCategory.ISOLATION, ["rear_delt", "rotator_cuff"], cns=1, shoulder=3, hyper=80, str_score=10),
